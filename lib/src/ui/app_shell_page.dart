...
class _AppShellPageState extends State<AppShellPage> {
  ...
  Future<Uint8List> _buildSheetPdfBytes() {
    return PracticeSheetPdfService.buildPdfBytes(
      ...
      showStrokeExamples: _controller.showStrokeExamples,
      showStrokePinyin: _controller.showStrokePinyin,
      sheetFont: _controller.sheetFont,
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        A4PracticeSheetPreview(
                          ...
                          showStrokeExamples: controller.showStrokeExamples,
                          showStrokePinyin: controller.showStrokePinyin,
                          sheetFont: controller.sheetFont,
